...
public class IncomeController {
    ...
    public ResponseEntity<List<Income>> getIncomesByProfile( @PathVariable Integer profileId) {
    
        List<Income> incomes =
                incomeRepository.findByFinancialProfileId(profileId);
    ...
    private void updateProfileMonthlyIncome(FinancialProfile profile) {
        List<Income> incomes =
                incomeRepository.findByFinancialProfileId(profile.getId());
